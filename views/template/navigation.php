				...
				<div class="actions left">
					<ul>
						...
						<?php if (!isset($tickets_page)): ?>
							<li><a href="http://www.bookeo.com/labyrinth">Purchase Tickets Now</a></li>
						<?php endif; ?>
						<li><a href="/chapters" class="<?= (($group == "chapters") ? "active" : "") ?>">Chapters</a></li>
						<li><a href="/faq" class="<?= (($group == "faq") ? "active" : "inactive") ?>">FAQ's</a></li>
						<li><a href="/contact" class="<?= (($group == "contact") ? "active" : "inactive") ?>">About Us & Contact</a></li>
					</ul>
				</div>
